          ...
          <div style={{ marginBottom: '8px' }}>
            <textarea
              ...
              style={{
                ...
                resize: 'none', overflowY: 'hidden', fontSize: '13px', lineHeight: 1.7,
        ...
        {isEditing ? (
          <input
            ...
            style={{
              ...
              outline: 'none', fontSize: '16px', letterSpacing: '0.05em', fontWeight: 700,
              color: C.name, textAlign: align, paddingBottom: '3px',
              width: '100%', fontFamily: 'inherit', marginBottom: '6px',
            }}
          />
        ) : char.name ? (
          <span style={{ fontSize: '16px', letterSpacing: '0.05em', fontWeight: 700, color: C.name, display: 'block', textAlign: align, marginBottom: '6px' }}>
            {char.name}
          </span>
        ) : null}
